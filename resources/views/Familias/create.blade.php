...
@section('Contenido')
<form class= "form-group" method="POST" action="/Familias/store">
  @csrf
<div class= "form-group">
  <h1>Crear Jefe de familia</h1>
  <label>IdJefeF: <input type="text" name="IdJefeF" class= "form-control" > </label><br>
  ...
  <label>Parentesco: <input type="text" name="Parentesco" class= "form-control" > </label><br>
