  <div class="col-xs-6 col-sm-3 sidebar-offcanvas" role="navigation">
        <ul class="list-group panel"> 
          ...
          <li>
            <a class="list-group-item" href="{{route('inicio_mensaje')}}"><i class="fa  fa-envelope"></i><span><em>Mensajería</em></span></a>
              <a class="list-group-item" href="{{route('inicio_albergue')}}"><i class="fa  fa-hospital-o"></i><span><em>Albergue</em></span></a>
            ...
            <span class="pull-right-container">
              ...
              <div class="collapse list-group-submenu child" id="SubMenu2">
                ...
                <a  class="list-group-item child" href="{{route('inicio_EntregaDonacionesA')}}"><i class="fa fa-user"></i><span><em>Entrega albergue</em></span></a>
          ...
          <a class="list-group-item" href="{{route('inicio_inventario')}}"><i class="fa  fa-list"></i><span>Lista de Inventarios</span></a>
